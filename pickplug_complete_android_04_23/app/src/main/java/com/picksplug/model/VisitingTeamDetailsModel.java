...
public class VisitingTeamDetailsModel implements Serializable{
    ...
    public static VisitingTeamDetailsModel fromJson(JSONObject jsonObject) {
        VisitingTeamDetailsModel teamDetailsModel = new VisitingTeamDetailsModel();

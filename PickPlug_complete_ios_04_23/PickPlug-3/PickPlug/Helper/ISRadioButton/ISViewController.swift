    ...
    @IBAction func logSelectedButton(_ isRadioButton:ISRadioButton){
        ...
        if isRadioButton.tag == 1000 {
            ...
            if isRadioButton.isEqual(self.btnAttributed1) {
                ...
                myString.addAttribute(NSAttributedStringKey.foregroundColor, value: UIColor.red, range: NSRange(location:0, length: 3))
                myString.addAttribute(NSAttributedStringKey.foregroundColor, value: UIColor.blue, range: NSRange(location:4, length: 4))
                self.btnAttributed1.setAttributedTitle(myString, for: .normal)
                
                let myString2 = NSMutableAttributedString(string:"Old Text")
                
                myString2.addAttribute(NSAttributedStringKey.foregroundColor, value: UIColor.green, range: NSRange(location:0, length: 3))
                myString2.addAttribute(NSAttributedStringKey.foregroundColor, value: UIColor.blue, range: NSRange(location:4, length: 4))
